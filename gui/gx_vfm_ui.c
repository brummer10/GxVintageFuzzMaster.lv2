...
static LV2UI_Handle instantiate(const LV2UI_Descriptor*   descriptor,
    ...
    *widget = NULL;
    ...
    const char* plug_name = "GxVintageFuzzMaster" ;
    ...
    set_expose_func(GX_VINTAGE_PAINT_BOX(ui->pbox),"pedal_expose");
    ui->box = gtk_vbox_new(FALSE, 4);
    ui->hbox = gtk_hbox_new(TRUE, 20);
    ...
    ui->adj[0] = gtk_adjustment_new( 0.2, 0.0, 1.0, 0.01, 0.01*10.0, 0);
    ...
    ui->adj[1] = gtk_adjustment_new( 0.0, 0.0, 1.0, 1.0, 1.0, 0);
    ui->knob[1] = gtk_switch_new_with_adjustment(GTK_ADJUSTMENT(ui->adj[1]));
    ui->label[1] = gtk_label_new("Tone");
    ...
    ui->args[2]->ui = ui;
    ui->args[2]->port_index = (int)VOLUME;
